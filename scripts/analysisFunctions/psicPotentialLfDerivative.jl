...
function psicPotentialLfDerivative(dataDirectory, show)
    ...
    save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/$(splitdir(dataDirectory)[end])/pdf/psicPotentialLfDerivative.pdf",fig)
    save("$dataDirectory/svg/psicPotentialLfDerivative.svg",fig)
    save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/$(splitdir(dataDirectory)[end])/svg/psicPotentialLfDerivative.svg",fig)
    save("$dataDirectory/png/psicPotentialLfDerivative.png",fig)
    save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/$(splitdir(dataDirectory)[end])/png/psicPotentialLfDerivative.png",fig)

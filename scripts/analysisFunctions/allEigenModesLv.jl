...
function allEigenModesLv(dataDirectory)
    # Import system data
    ...
    isdir("/Users/christopher/Dropbox (The University of Manchester)/Chris-Oliver Shared/VertexModelFigures/$(splitdir(dataDirectory)[end])/eigenmodesLv") ? nothing : mkpath("/Users/christopher/Dropbox (The University of Manchester)/Chris-Oliver Shared/VertexModelFigures/$(splitdir(dataDirectory)[end])/eigenmodesLv")
    ...
    for eigenvectorIndex=2:nVerts
        ...
        #save("/Users/christopher/Dropbox (The University of Manchester)/Chris-Oliver Shared/VertexModelFigures/$(splitdir(dataDirectory)[end])/eigenmodesLv/eigenmode$(@sprintf("%03d", eigenvectorIndex)).png",fig)
    end
end

...
vertexModel(initialSystem,realTimetMax*1.0,realCycleTime,γ[2],L₀[2],A₀,viscousTimeScale,0.01,pressureExternal,peripheralTension*0.0,t1Threshold,outputTotal,outputToggle,plotToggle;subFolder="test")

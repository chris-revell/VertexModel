...
vertexModel(initialSystem,realTimetMax,realCycleTime,γ[1],L₀[1],A₀,viscousTimeScale,pressureExternal,peripheralTension*0.1,t1Threshold,outputTotal,outputToggle,plotToggle;subFolder="newTest")

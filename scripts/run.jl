...
vertexModel(initialSystem,realTimetMax*5.0,realCycleTime,γ[2],L₀[2],A₀,viscousTimeScale,dt,pressureExternal,peripheralTension*0.0,t1Threshold*5,outputTotal,outputToggle,plotToggle;subFolder="annealing")

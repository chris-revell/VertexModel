...
display(fig)
save("$dataDirectory/png/eigenvectorTableauLc.pdf",fig)
...
save("$dataDirectory/png/eigenvectorTableauLc.svg",fig)
...
save("$dataDirectory/png/eigenvectorTableauLc.png",fig)

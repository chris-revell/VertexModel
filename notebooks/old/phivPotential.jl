...
save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/pdf/phi^vPotential.pdf",fig)
save("$dataDirectory/phi^vPotential.svg",fig)
save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/svg/phi^vPotential.svg",fig)
save("$dataDirectory/phi^vPotential.png",fig)
save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/png/phi^vPotential.png",fig)

...
image!(ax2,rotr90(load("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/OtherFigures/geometryCb.png")))

ax3 = Axis(fig[1,3],aspect=DataAspect())
hidedecorations!(ax3)
hidespines!(ax3)
Label(fig[1,3,Bottom()],L"(c)",textsize = 32)
image!(ax3,rotr90(load("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/OtherFigures/geometryCc.png")))
...
# save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/figure1.pdf",fig)
# save("$dataDirectory/svg/figure1.svg",fig)
# save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/figure1.svg",fig)
# save("$dataDirectory/png/figure1.png",fig)
save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/figure1.eps",fig)
save("/Users/christopher/Dropbox (The University of Manchester)/VertexModelFigures/figure1.png",fig)
